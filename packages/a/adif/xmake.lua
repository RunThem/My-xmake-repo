package("adif")
    ...
    set_description("用标准c语言开发的常用数据结构和算法基础库，作为应用程序开发接口基础库，为编写高性能程序提供便利，可极大地缩短软件项目的开发周期，提升工程开发效率，并确保软件系统运行的可靠性、稳定性。")
    set_license("MIT")

    add_urls("https://github.com/kehengzhong/adif/archive/refs/tags/$(version).tar.gz",
